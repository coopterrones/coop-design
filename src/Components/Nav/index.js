    ...
    <div className="nav-bar">
      ...
      <div className="about-me-scroll-container">
        <div className="scroll-text">
          ...
          creative front end web developer looking to lend a unique perspective
          to your biz. I love food, clothes, film photo, music, tech, etc...
          show me something cool and I'll probably be interested and dive in.
          Currently looking for my first Junior Role while putting in some time
          at Canoe Club a menswear shop in Boulder, CO... Hope this finds you
          well. "It's not what you don't know that kills you. It's what you know
          for sure that just ain't so..." -Mark Twain ... ♥️♥️♥️
        </div>
      </div>
      <Link
